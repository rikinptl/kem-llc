...
const CTASection = () => {
  return (
    <section className="py-24 md:py-32 px-6 lg:px-12 bg-surface text-white relative overflow-hidden border-t border-white/[0.06]">
      <div className="pointer-events-none absolute inset-0 bg-ambient opacity-55" aria-hidden />
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <Link to="/contact" className="inline-flex items-center justify-center border border-white/25 text-white/90 px-10 py-4 font-semibold text-sm tracking-tight rounded-full hover:border-accent hover:text-accent transition-colors duration-300">
            Book a call
          </Link>
        </motion.div>
      </div>
