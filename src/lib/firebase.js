...
const firebaseConfig = {
  ...
  // Keep the default Firebase auth domain — OAuth redirect URIs are auto-registered there.
  // kemtrade.us stays in Firebase authorized domains; sign-in uses redirect back to this site.
